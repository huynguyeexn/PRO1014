...
DROP DATABASE IF EXISTS `pro1014`;
...
DROP TABLE IF EXISTS `brand_of_product`;
...
DROP TABLE IF EXISTS `color_of_product`;
...
-- Dumping data for table pro1014.product: ~10 rows (approximately)
DELETE FROM `product`;
...
DROP TABLE IF EXISTS `tag_of_product`;
