...
INSERT IGNORE INTO `config` (`id`, `name`, `config`) VALUES
...
INSERT IGNORE INTO `deal` (`id`, `end_time`, `start_time`) VALUES
...
INSERT IGNORE INTO `product` (`id`, `name`, `price`, `description`, `thumb`, `images`, `update`, `cost`, `brand_id`) VALUES
...
INSERT IGNORE INTO `product_detail` (`product_id`, `color_id`, `size_id`, `quantity`) VALUES
	(1, 1, 38, 26),
	(1, 10, 38, 50),
	(1, 1, 39, 13),
	(1, 1, 42, 31);
...
INSERT IGNORE INTO `slider` (`id`, `product_id`, `priority`, `description`, `title`, `img`) VALUES
...
INSERT IGNORE INTO `tag_product` (`id`, `name`) VALUES
	(1, 'Superstar Shoes'),
	(2, 'NMD'),
	(3, 'Athletic & Sneakers'),
	(4, 'Ultraboost'),
...
INSERT IGNORE INTO `user` (`id`, `username`, `password`, `email`, `phone`, `created`, `birthday`, `fullname`, `avartar`, `rank`) VALUES
