...
REPLACE INTO `brand` (`id`, `name`, `update`) VALUES
...
REPLACE INTO `comment` (`id`, `product_id`, `user_id`, `content`) VALUES
	(1, 1, 1, 'This is comment.'),
	(2, 1, 2, 'This is comment.'),
	(3, 2, 3, 'This is comment.'),
	(4, 1, 3, 'This is comment.');
...
-- Dumping data for table pro1014.deal_detail: ~1 rows (approximately)
/*!40000 ALTER TABLE `deal_detail` DISABLE KEYS */;
REPLACE INTO `deal_detail` (`deal_id`, `product_id`, `deal_thumb`, `deal_price`, `quantity`, `sold`) VALUES
	(1, 1, 'assets/img/product/1/1.jpg', 75, 100, 13),
	(1, 5, 'assets/img/product/2/1.jpg', 80, 100, 27);
...
-- Dumping data for table pro1014.order: ~5 rows (approximately)
/*!40000 ALTER TABLE `order` DISABLE KEYS */;
REPLACE INTO `order` (`id`, `user_id`, `status`, `created`) VALUES
	(1, 1, 0, '2020-11-10 18:40:53'),
	(2, 3, 1, '2020-10-27 18:40:53'),
	(3, 1, 3, '2020-11-20 12:36:53'),
	(4, 2, 1, '2020-11-06 23:33:53'),
	(5, 2, 0, '2020-11-07 16:02:53');
...
REPLACE INTO `product` (`id`, `name`, `price`, `description`, `thumb`, `images`, `update`, `cost`, `brand_id`) VALUES
...
REPLACE INTO `slider` (`id`, `product_id`, `priority`, `description`, `title`, `img`) VALUES
...
REPLACE INTO `tag_blog` (`id`, `name`) VALUES
	(1, 'Yeezy'),
	(2, 'Air Max 98'),
	(3, 'Air Jordan 11'),
	(4, 'Air Max 270'),
...
REPLACE INTO `tag_product` (`id`, `name`) VALUES
	(1, 'Superstar Shoes'),
	(2, 'NMD'),
	(3, 'Athletic & Sneakers'),
	(4, 'Ultraboost'),
...
REPLACE INTO `user` (`id`, `username`, `password`, `email`, `phone`, `created`, `birthday`, `fullname`, `avartar`, `rank`) VALUES
	(1, 'huy', '123', 'huy@gmail.com', '09090909', '2020-10-10 05:37:57', '2001-04-21 18:38:23', 'Nguyễn Văn Huy', 'assets/images/user/1.jpg', 10),
	(2, 'dien', '123', 'dien@gmail.com', '08080808', '2020-10-11 01:37:58', '2001-05-05 18:38:24', 'Nguyễn Văn Điền', 'assets/images/user/2.jpg', 1),
	(3, 'dung', '123', 'dung@gmail.com', '07070707', '2020-10-10 08:37:59', '2001-07-15 18:38:25', 'Nguyễn Văn Dung', 'assets/images/user/4.jpg', 0);
