...
<body class="vertical  dark  ">
    <div class="wrapper">
        ...
        <div class="col-md-10 my-4 float-right">
            <form action="admin.php?c=brand&a=update&id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control" id="show" name="show">
                        <option value="1" <?php echo ($brand['show']==1?'selected':''); ?>>Hiện</option>
                        <option value="0"  <?php echo ($brand['show']==0?'selected':''); ?>>Ẩn</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="priority">Thứ tự:</label>
                    <input type="text" name="priority" id="priority" class="form-control"  value="<?php echo $brand['priority']; ?>">
                </div>
                <button type="submit" class="btn btn-block btn-primary">Cập nhật nhãn hàng</button>
            </form>
