...
<body class="vertical  dark  ">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="card shadow">
                            <div class="card my-4">
                                <form action="admin.php?c=user&p=edit&id=<?php echo $user['id'];?>" method="post" onsubmit="return loi()" enctype="multipart/form-data">
                                    <section id="account">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div style="padding:0px;" class="card-body">
                                                            <div id="khunganh" class="drag mt-3">
                                                              <img id='kanh'  src="<?php echo $user['thumb']?>" alt="">
                                                            </div>
                                                    ...
                                                    <div class="col-md-8 my-4 ml-5">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9 mb-3">
                                                                <input type="text" class="form-control" id="ten" name="name" value="<?php echo $user['name']?>">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9 mb-3">
                                                                    <input type="text" id="giag" class="form-control" name="cost" value="<?php echo $user['cost']?>">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9 mb-3">
                                                                    <input type="text" id="giab" class="form-control" name="price" value="<?php echo $user['price']?>">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3" for="exampleFormControlTextarea1">Cấp b</label>
                                                            <div class="col-sm-9 mb-3">
                                                ...
                                                <div class="form-group row  float-right">
                                                    <div class="col-sm-4 mb-3 float-right">
                                                        <input type="button" onclick="next(<?php echo $user['id'];?>);" style="width: 100px;height:35px;font-size:18px;background:#1b68ff;border:1px solid #1b68ff;border-radius:5px;color:white;" value="Next">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
      ...
      function next(z) {
        ...
        hien = 0;
        if (hinh.src == 'http://localhost/pro1014/assets/img/user/') {
